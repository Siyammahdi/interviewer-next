        ...
        <Section Bgcolor={"#fff"}>
            <div className='text-center w-1/3 mx-auto text-gray-500 text-sm'>
                ...
                <div>
                    <div className='flex justify-center'>
                        <div className='bg-white p-5 w-full rounded-2xl shadow-xl'>
                            ...
                            <div className='pt-10'>
                                ...
                                <p>Drag your file here and click to <span className='text-blue-500 font-semibold'>Upload</span></p>
                            </div>
                    ...
                    <div>
                        <div className='absolute left-64 top-[3150px]'>
                            <p>01</p>
                            <p className='text-7xl my-10 text-gray-300 font-bold'>02</p>
                            <p>03</p>
                            <p>04</p>
                        </div>
                        <div className='flex gap-20 bg-white absolute left-32 top-[3255px]'>
